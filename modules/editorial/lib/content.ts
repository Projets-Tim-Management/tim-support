...
/**
 * Couche de lecture Payload pour l'ÉDITORIAL (features, parcours, taxonomies),
 * aux mêmes types de retour que l'ancien accès WordPress. Le métier (points,
 * missions, récompenses…) vit dans lib/partner.ts.
 */
