...
- **Carte** : un point par client **Gagnée**, à son adresse de facturation (géocodée par la Base Adresse Nationale quand l'adresse change ; taille du point selon le CA mensuel). Sans adresse, ou adresse inconnue de la BAN, pas de point — le nombre de fiches sans point est dit sous la carte.
